...
# Form implementation generated from reading ui file 'C:\Users\user\PycharmProjects\SimulationOfLaboratoryWork\forms_ui\laba11.ui'
#
...
class Ui_Laba11(object):
    def setupUi(self, Laba11):
        ...
        self.label_8.setGeometry(QtCore.QRect(670, 260, 181, 31))
        ...
        self.label_resistors_shop.setGeometry(QtCore.QRect(562, 296, 407, 285))
        self.label_resistors_shop.setText("")
        self.label_resistors_shop.setPixmap(QtGui.QPixmap("C:\\Users\\user\\PycharmProjects\\SimulationOfLaboratoryWork\\forms_ui\\../images/laba_11/resistor_store.png"))
        ...
        self.dial_4.setGeometry(QtCore.QRect(604, 486, 69, 67))
...
"background-color: rgb(28, 30, 29);")
        ...
        self.resistors_store.setGeometry(QtCore.QRect(564, 590, 401, 21))
        ...
        self.resetButton.setGeometry(QtCore.QRect(704, 620, 151, 71))
        ...
        self.label_resistors.setGeometry(QtCore.QRect(10, 106, 201, 141))
        self.label_resistors.setText("")
        self.label_resistors.setPixmap(QtGui.QPixmap("C:\\Users\\user\\PycharmProjects\\SimulationOfLaboratoryWork\\forms_ui\\../images/laba_11/default_resistors.png"))
        self.label_resistors.setScaledContents(True)
        self.label_resistors.setObjectName("label_resistors")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(222, 114, 293, 34))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(222, 154, 279, 89))
        ...
        self.label_power_supply.setGeometry(QtCore.QRect(36, 584, 331, 111))
        self.label_power_supply.setText("")
        self.label_power_supply.setPixmap(QtGui.QPixmap("C:\\Users\\user\\PycharmProjects\\SimulationOfLaboratoryWork\\forms_ui\\../images/laba_11/power_supply_off.png"))
        self.label_power_supply.setScaledContents(True)
        self.label_power_supply.setObjectName("label_power_supply")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(624, 52, 283, 203))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.dial_5 = QtWidgets.QDial(self.centralwidget)
        self.dial_5.setGeometry(QtCore.QRect(732, 486, 69, 67))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(28, 30, 29))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"background-color: rgb(28, 30, 29);")
        ...
        self.dial_6.setGeometry(QtCore.QRect(858, 486, 69, 67))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(28, 30, 29))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"background-color: rgb(28, 30, 29);")
        ...
        self.dial_1.setGeometry(QtCore.QRect(604, 362, 69, 67))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(28, 30, 29))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"background-color: rgb(28, 30, 29);")
        ...
        self.dial_2.setGeometry(QtCore.QRect(732, 362, 69, 67))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(28, 30, 29))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"background-color: rgb(28, 30, 29);")
        ...
        self.dial_3.setGeometry(QtCore.QRect(858, 362, 69, 67))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(28, 30, 29))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
...
"background-color: rgb(28, 30, 29);")
        ...
        self.label_voltage_divider.setGeometry(QtCore.QRect(54, 384, 303, 111))
        self.label_voltage_divider.setText("")
        self.label_voltage_divider.setPixmap(QtGui.QPixmap("C:\\Users\\user\\PycharmProjects\\SimulationOfLaboratoryWork\\forms_ui\\../images/laba_11/voltage_divider.png"))
        self.label_voltage_divider.setScaledContents(True)
        self.label_voltage_divider.setObjectName("label_voltage_divider")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(52, 496, 315, 29))
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 526, 315, 29))
